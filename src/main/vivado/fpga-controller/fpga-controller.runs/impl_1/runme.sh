...
HD_PWD='D:/projects/aquaponic-controller/src/main/vivado/fpga-controller/fpga-controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_controller_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fpga_controller_top.tcl -notrace
