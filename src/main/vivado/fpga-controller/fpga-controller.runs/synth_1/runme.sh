...
HD_PWD='D:/projects/aquaponic-controller/src/main/vivado/fpga-controller/fpga-controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fpga_controller_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fpga_controller_top.tcl
